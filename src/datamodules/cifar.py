...
class CifarDataModule(LightningDataModule):
    ...
    def setup(self, stage=None) -> None:
        self.train_dataset = CifarDataset(train=True, data_dir=self.data_dir)
        self.val_dataset = CifarDataset(train=False, data_dir=self.data_dir)
...
if __name__ == "__main__":
    dm = CifarDataModule(128, 2, [3, 32, 32], "./data")
    dm.setup()
