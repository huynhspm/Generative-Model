...
class MnistDataset(Dataset):
    ...
    def prepare_data(self) -> None:
        self.dataset = MNIST(self.data_dir, download=True,
...
class MnistDataModule(LightningDataModule):
    ...
    def setup(self, stage=None) -> None:
        self.train_dataset = MnistDataset(train=True, data_dir=self.data_dir)
        self.val_dataset = MnistDataset(train=False, data_dir=self.data_dir)
